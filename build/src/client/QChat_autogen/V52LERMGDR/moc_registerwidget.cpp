...
static constexpr auto qt_meta_stringdata_ZN14RegisterWidgetE = QtMocHelpers::stringData(
    "RegisterWidget",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14RegisterWidgetE[] = {
...
Q_CONSTINIT const QMetaObject RegisterWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14RegisterWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14RegisterWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14RegisterWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *RegisterWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14RegisterWidgetE.stringdata0))
